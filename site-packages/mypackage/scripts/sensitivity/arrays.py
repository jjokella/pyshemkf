...
import mypackage.scripts.sensitivity.variables as sv
...
varranges = {
    'cubey_2017_01_15_a': np.arange(0.5*10**6, 3.5*10**6, 0.003*10**6),
...
varranges_sense = {
    ...
    'cubey_2017_06_07_b': np.array([sv.lam_smax/sv.rc_smin,
                                    sv.lam_smin/sv.rc_smax]),
    'cubey_2017_06_07_aln': np.array([sv.lam_smax/sv.rc_smin,
                                      sv.lam_smin/sv.rc_smax]),
    'cubey_2017_06_07_bxz': np.array([sv.lam_cmin/sv.rc_cmax,
                                      sv.lam_cmax/sv.rc_cmin]),
}

# Sensitivity analysis:  Varied variables ################################
sensitivity_varnames = {
    'cubey_2016_12_13_a': 'Thermal conductivity deprecated',
...
sensitivity_ranges = {
    'cubey_2016_12_13_a': r'1.5-3.0 $\frac{W}{mK}$ deprecated',
    ...
    'cubey_2017_06_02_b': (r'$1.0 \cdot 10^-8$ '
                           + '- $1.0 \cdot 10^-5$ $\frac{m}{s}$'),
    'cubey_2017_06_07_b': (r'$1.47\cdot 10^-6$'
                           + '-$0.78\cdot 10^-6$ $\frac{m^2}{s}$'),
    'cubey_2017_06_07_aln': (r'$1.47\cdot 10^-6$'
                             + '-$0.78\cdot 10^-6$ $\frac{m^2}{s}$'),
    'cubey_2017_06_07_bxz': (r'$0.68\cdot 10^-6$'
                             + '-$2.08\cdot 10^-6$ $\frac{m^2}{s}$'),
}

# Sensitivity analysis:  Default numbers #################################
default_values = {
    'cubey_2017_01_15_a': 2.82*10**6,
...
default_strings = {
    'cubey_2017_01_15_a': r'2.82 $10^6 \frac{J}{Km^3}$',
