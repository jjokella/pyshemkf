...
def read(
    ...
    # Uindex possibly own model specifiers
    if (uindex_model_name is None
            or uindex_dat is None
            or uindex_let is None
            or uindex_nt is None):
        uindex_model_name = model_name
        uindex_dat = dat
        uindex_let = let
        uindex_nt = nt
    ...
    uindex_array_name = pm.py_output_filename(
        fa.tag,
        'uindex',
        sc.specl(uindex_model_name, uindex_dat, uindex_let)+'_'+str(uindex_nt),
        "npy"
    )
