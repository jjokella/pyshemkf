...
def plot(
    ...
    probs = np.load(
        pm.py_output_filename(
            na.tag,
            'probs_'+which_res, model+'_'+str(n_runs)
            + '_'+method+'_'+str(enssize)+'_'+str(n_syn)+'_'
            + str(n_comparisons)+'_'
    ...
    probs_bold = np.load(
        pm.py_output_filename(
            na.tagn,
            'probs_'+which_res,
            model+'_'+str(n_runs)+'_'
            + method+'_'+str(enssize)+'_'+str(n_syn_bold)
    ...
    pic_name = pm.py_output_filename(
        na.tag,
        'bars_'+which_res,
        model+'_'+str(n_runs)+'_'+method+'_'+str(enssize)
