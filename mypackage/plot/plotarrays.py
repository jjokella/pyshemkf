...
num_methods = 17
num_jobs = num_methods*6

num_methods1000 = 4
num_jobs1000 = num_methods1000*3
...
normalscoreverynew_dats = ['2015_10_01','2015_10_01','2015_10_01','2015_10_01','2015_10_01','2015_10_01']
hybrid_dats = ['2015_10_02','2015_10_02','2015_10_02','2015_10_02','2015_10_02','2015_10_02']
...
newiterative4_dats = ['2015_12_11','2015_12_11','2015_12_11','2015_12_11','2015_12_11','2015_12_11']
...
normal1000_dats = ['2015_11_26','2015_11_26','2015_11_26']
damping1000_dats = ['2015_11_27','2015_11_27','2015_11_27']
normalscore1000_dats = ['2015_12_05','2015_12_05','2015_12_05']
dual1000_dats = ['2015_12_05','2015_12_05','2015_12_05']
...
normalscoreverynew_lets = ['b','cx','gt','kp','ol','sh']
hybrid_lets = ['b','cx','gt','kp','ol','sh']
...
newiterative4_lets = ['b','aln','bxz','dkl','ewx','gjj']
obs_10_normal_lets = ['b','cx','gt','kp','ol','sh']
obs_200_normal_lets = ['b','cx','gt','kp','ol','sh']
lowobsvar_lets = ['b','cx','gt','kp','ol','sh']

normal1000_lets = ['b','aln','bxz']
damping1000_lets = ['b','aln','bxz']
normalscore1000_lets = ['b','aln','bxz']
dual1000_lets = ['dkl','ewx','gjj']
...
normalscoreverynew_nums = [100,100,100,100,100,34] 
hybrid_nums = [100,100,100,100,100,100]
...
newiterative4_nums = [99,88,22,16,8,4]
...
normal1000_nums = [1000,1000,1000]
damping1000_nums = [1000,1000,1000]
normalscore1000_nums = [1000,1000,641]
dual1000_nums = [1000,665,872]

dats = [normal_dats, normalscore_dats, damping_dats, localisation_dats, dual_dats, damping03_dats, 
        damping01_dats, normalscorenew_dats, normalscoreverynew_dats, hybrid_dats, damping02_dats,
        iterative_dats, iterative_2_dats, newiterative_dats,newiterative2_dats,
        newiterative3_dats, newiterative4_dats,
        obs_10_normal_dats, obs_200_normal_dats, lowobsvar_dats]
lets = [normal_lets, normalscore_lets, damping_lets, localisation_lets, dual_lets, damping03_lets,
        damping01_lets, normalscorenew_lets, normalscoreverynew_lets, hybrid_lets, damping02_lets,
        iterative_lets, iterative_2_lets, newiterative_lets,newiterative2_lets,
        newiterative3_lets,newiterative4_lets,
        obs_10_normal_lets, obs_200_normal_lets, lowobsvar_lets]
nums = [normal_nums, normalscore_nums, damping_nums, localisation_nums, dual_nums, damping03_nums,
        damping01_nums, normalscorenew_nums, normalscoreverynew_nums, hybrid_nums, damping02_nums,
        iterative_nums, iterative_2_nums, newiterative_nums,newiterative2_nums,
        newiterative3_nums,newiterative4_nums,
...
dats1000 = [normal1000_dats,damping1000_dats,normalscore1000_dats,dual1000_dats]
lets1000 = [normal1000_lets,damping1000_lets,normalscore1000_lets,dual1000_lets]
nums1000 = [normal1000_nums,damping1000_nums,normalscore1000_nums,dual1000_nums]
...
names_methods = ['EnKF', 'NS-EnKF', 'Dam0.5', 'LEnKF', 'DualEnKF', 
                 'Dam0.3', 'Dam0.1', 'NS-EnKF2', 'NS-EnKF3', 'Hyb-EnKF', 
                 'Dam0.2', 'IEnKF1', 'IEnKF2', 'NIEnKF', 'NIEnKF2',
                 'NIEnKF3','NIEnKF4']

names_methods1000 = ['EnKF','Dam0.1','NS-EnKF','DualEnKF']
