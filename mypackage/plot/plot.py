...
pc_var_name = 'kz',                 # 'kz', 'conc', 'head'
pc_is_show_ens = 0,                 
pc_num_ens = 20,
pc_fig_title_text = None,
pc_title_text = None,
pc_text = None,
pc_text_x = 5,                            #units of the axes
pc_text_y = 0.6,
pc_x_min = 0,
pc_x_max = 20,
pc_y_min = 0.0,
...
pc_pic_ending = '.png'
    ...
    pc_in={'pc_output': pc_output,
           ...
           'pc_var_name':pc_var_name,
           'pc_is_show_ens': pc_is_show_ens,
           'pc_num_ens': pc_num_ens,
           'pc_fig_title_text':pc_fig_title_text,
