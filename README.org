...
* Scripts
** endresread.ipy
The script =endresread.ipy= ([[scripts/endresread.ipy][=endresread.ipy=]]) ([[/scripts/]]) ([[scripts/]])
([[/site-packages/mypackage/scripts/]])is not part of one of the scripting
tags for historical reasons and because it has the basic preliminary
task of reading RMSEs from =SHEMAT-Suite= output.
** analysis
** errorplot
** forward
** gaussianity
