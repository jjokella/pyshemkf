...
- Input files
  ...
  - SGSim input fields =sgsim_k_<modelname>_true.par=
...
the basic preliminary task of reading RMSE distributions from
=SHEMAT-Suite= output.
** tag-scripts
...
figures are saved, figures are shown and a backup of the script is
generated in the corresponding =backup= directory.
** templates
