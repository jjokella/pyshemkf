...
=PythonDir= is a python environment for post-processing =SHEMAT-Suite=
([[*Rath 2006][Rath 2006]]) output. It can help to generate 2D-figures of variables
and parameters. Most notably, =PythonDir= contains scripts and
...
-----
* General structure
Explanation of the general idea behind the =PythonDir= structure and
